...
app.get("/api/scan", async (req, res) => {
  ...
  // rather than pulling everything the odds API has scheduled out for the
  // next week or two. 0 or "all" disables the window entirely.
...
.side-arrow.up path{fill:var(--green,#3ddc84)}
.side-arrow.down path{fill:var(--red,#e08579)}
